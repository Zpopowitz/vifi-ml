...
| **H2** | Middleware + SPA mount → `api_internals/{middleware,spa}.py` | TBD | ✅ |
...
| PR | What | Gating |
|---|---|---|
| H3 | Route handlers → factory pattern w/ deps injection | Quiet stretch (risky refactor; routes share closure vars) |
