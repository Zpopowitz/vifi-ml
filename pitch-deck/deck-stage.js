...
(() => {
  ...
  const stylesheet = `
    ...
    .btn {
      ...
      margin: 0; padding: 0; color: inherit; font: inherit; cursor: default;
    ...
    .btn.reset { font-size: 11px; font-weight: 500; letter-spacing: 0.02em; padding: 0 10px 0 12px; gap: 6px; color: rgba(255,255,255,0.72); }
    .btn.reset .kbd {
      display: inline-flex; align-items: center; justify-content: center;
  ...
  class DeckStage extends HTMLElement {
    ...
    _persistIndex() {
      try { localStorage.setItem(this._storageKey, String(this._index)); } catch (e) { /* ignore */ }
    }
